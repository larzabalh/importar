$( document ).ready(function() {
  ...
  $('#back-item').tooltipster({
    theme: ['tooltipster-noir'],   animation: 'fade',  delay: 300,
  ...
  $( "#idCountry" ).on( "change", function() {
    if($(this).val()==0){
      ...
      $.ajax({
        type : 'GET',
        url : '/Finanzas/masters/states/byCountry',
        beforeSend: function () {
          $( "#idState" ).empty();
          $( "#idState_img" ).show();
          $( "#idState" ).hide();
...
$( "#idImmigrationSituation" ).on( "change", function() {
  ...
  if($(this).val()==0){
    ...
    $.ajax({
      type : 'GET',
      url : '/Finanzas/masters/immigrationsituation/jsonById',
      beforeSend: function () {
      },
      data : {
  ...
  $('#add-button-contact').click( function(){
    ...
    var idPersonalFile1 = $('#idPersonalFile').val();
...
.attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var label1 = $('<label>').attr('for', 'idCountryContact')
      .attr('class', 'control-label').text('Nacionalidad *');
    var nat = $("<select>").attr("name", "idCountry")
      .attr("class", "form-control").attr("id", 'idCountryContact');

        $.ajax({ type : 'GET', url : '/Finanzas/masters/countrys/allCountrys',
       })
       .done(function(response){
    ...
    var div2 = $('<div>')
.attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var label2 = $('<label>').attr('for', 'personalIDContact')
      .attr('class', 'control-label').text('Cédula / DNI / Documento *');
    var personalID = $("<input>").attr("type", "text").attr("name", "personalID")
    ...
    var div3 = $('<div>')
.attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var label3 = $('<label>').attr('for', 'alternativePersonalIDContact')
      .attr('class', 'control-label').text('Precaria / Documento Temporal');
    var alternativePersonalID = $("<input>").attr("type", "text")
    ...
    var divfn = $('<div>')
.attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var labelfn = $('<label>').attr('for', 'firstNameContact')
    ...
    var divln = $('<div>')
.attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var labelln = $('<label>').attr('for', 'lastNameContact')
    ...
    var div4 = $('<div>')
.attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var label4 = $('<label>').attr('for', 'idRelationTypeContact')
      .attr('class', 'control-label').text('Parentesco');
      var relation = $("<select>").attr("name", "idRelationType")
        .attr("class", "form-control").attr("id", 'idRelationTypeContact');

      $.ajax({ type : 'GET', url : '/Finanzas/masters/relationship/allRelations',
       })
       .done(function(response){
    ...
    var div5 = $('<div>')
.attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var label5 = $('<label>').attr('for', 'idCountryResidenceContact')
      .attr('class', 'control-label').text('País Residencia *');
    var idCountryRes = $("<select>").attr("name", "idCountryResidence")
    ...
    var div6 = $('<div>')
    .attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
    var label6 = $('<label>').attr('for', 'idStateContact')
      .attr('class', 'control-label').text('Provincia / Localidad / Estado');
      var idState = $("<select>").attr("name", "idState")
        .attr("class", "form-control").attr("id", 'idStateContact');

      $.ajax({ type : 'GET', url : '/Finanzas/masters/states/byCountry',
      beforeSend: function () {
     ...
     var div7 = $('<div>')
 .attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
     var label7 = $('<label>').attr('for', 'addressContact')
       .attr('class', 'control-label').text('Dirección Residencia');
     var addressContact = $("<input>").attr("type", "text")
     ...
     $(div7).append( $(addressContact) );
      ...
      var div8 = $('<div>')
  .attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
      var label8 = $('<label>').attr('class', 'control-label')
      .text('Teléfono Móvil *');

      var mobilePhoneContact = $("<input>").attr("type", "text")
      ...
      var div9 = $('<div>')
  .attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
      var label9 = $('<label>').attr('class', 'control-label')
      .text('Teléfono Local *');

      var localPhoneContact = $("<input>").attr("type", "text")
      ...
      var div10 = $('<div>')
  .attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
      var label10 = $('<label>').attr('for', 'addressContact')
        .attr('class', 'control-label').text('Email');
      var emailContact = $("<input>").attr("type", "text")
  ...
  .attr('class', 'col-xs-12 col-sm-4 col-md-4 col-lg-3 form-group input-groups');
      var br = $('<br>');
      var emergency = $("<input>").attr("type", "checkbox")
        .attr("name", "emergencyContact")
        .attr("id", 'emergencyContact').attr('value', '1');
      var label11 = $('<label>').attr('for', 'emergencyContact')
  ...
  .attr('class', 'col-xs-12 col-sm-12 col-md-12 col-lg-12');
      var save = $("<input>").attr("type", "submit")
  ...
  $('#store-pf').validate({
    ...
    submitHandler: function(form){
      ...
      $.ajax({
        type : 'GET',
        url : '/Finanzas/masters/personalfile/findByPersonalID',
        beforeSend: function () {
  ...
  $('#store-ff').validate({
    ...
    submitHandler: function(form){
      ...
      $.ajax({
        type : 'GET',
        url : '/Finanzas/masters/personalfile/findByForeignID',
        beforeSend: function (jqXHR) {
          if($('#idPersonalFile').val()==''){
            $('#label-form-pf').click();
            $('#send-button-pf').click();

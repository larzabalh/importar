            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ route('admin') }}">
                        <i class="fa fa-home fa-fw"></i>{{ config('app.name') }}
                    </a>
                </div>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav in" id="side-menu">
                            ...
                            <li>
                                <a href="http://secondtruth.github.io/startmin/pages/index.html" class="active"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse">
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/flot.html">Flot Charts</a>
                                    </li>
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/morris.html">Morris.js Charts</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            <li>
                                <a href="http://secondtruth.github.io/startmin/pages/tables.html"><i class="fa fa-table fa-fw"></i> Tables</a>
                            </li>
                            <li>
                                <a href="http://secondtruth.github.io/startmin/pages/forms.html"><i class="fa fa-edit fa-fw"></i> Forms</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-wrench fa-fw"></i> UI Elements<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse">
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/panels-wells.html">Panels and Wells</a>
                                    </li>
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/buttons.html">Buttons</a>
                                    </li>
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/notifications.html">Notifications</a>
                                    </li>
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/typography.html">Typography</a>
                                    </li>
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/icons.html"> Icons</a>
                                    </li>
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/grid.html">Grid</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level collapse">
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/blank.html">Blank Page</a>
                                    </li>
                                    <li>
                                        <a href="http://secondtruth.github.io/startmin/pages/login.html">Login Page</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
